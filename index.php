...
{
	header("location: components\scripts\php\client\public\login.php");
	exit;
}
?>
...
<body>
	...
	<p>
		...
		<a href="components/scripts/php/client/private/logout.php" class="btn btn-danger ml-3">Sair da conta</a>
	</p>
</body>
